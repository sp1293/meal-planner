export default function Guidelines({ navigate }) {
  const studentRules = [
    { icon: "💳", title: "Pay only through NourishAI", desc: "Never pay trainers directly via UPI, cash, or bank transfer. All payments must go through our secure platform. This protects you with refund rights and session guarantees." },
    { icon: "🔒", title: "Keep contact details private", desc: "Do not share your personal phone number, WhatsApp, Instagram, or email with trainers. All communication happens through NourishAI's messaging system." },
    { icon: "📹", title: "Use only NourishAI session links", desc: "Video sessions are conducted via secure links provided by NourishAI. Never accept external Zoom/Meet links from trainers outside the platform." },
  ...
  const trainerRules = [
    { icon: "💰", title: "Receive payments through NourishAI only", desc: "All session payments are processed through NourishAI and transferred to your account within 3-5 business days after session completion. Never request direct payment from students." },
    ...
    { icon: "📊", title: "Commission structure", desc: "NourishAI retains a platform commission from each booking to cover payment processing, platform maintenance, and student acquisition. You keep the majority of each session fee." },
  ];
  ...
  return (
    <div className="page-md" style={{ margin: "0 auto", padding: "48px 24px" }}>
      <div className="page-title anim-fade-up">
        ...
        <p>Rules and security guidelines for all NourishAI users. Please read carefully before using the platform.</p>
      </div>
      ...
      <div className="card anim-fade-up-2" style={{ marginBottom: 24, background: "var(--primary-pale)", border: "1px solid var(--primary-soft)" }}>
        ...
        <p style={{ fontSize: 14, color: "var(--text-2)", lineHeight: 1.8 }}>
          NourishAI is a trusted marketplace connecting students with certified wellness professionals.
      ...
      <div className="card anim-fade-up-4" style={{ marginBottom: 24, border: "2px solid #fecaca", background: "#fff5f5" }}>
        ...
        <p style={{ fontSize: 14, color: "#7f1d1d", lineHeight: 1.7, marginBottom: 16 }}>
          Attempting to bypass NourishAI — including arranging direct payments, sharing personal contact details,
        ...
        <div style={{ background: "#fef2f2", borderRadius: "var(--radius-sm)", padding: 14, fontSize: 13, color: "#991b1b", fontWeight: 500 }}>
          💡 Why do we enforce this strictly? NourishAI invests significantly in acquiring students, maintaining the platform, processing payments securely, and vetting trainers. Off-platform activity harms the entire community and undermines the trust that makes NourishAI valuable for everyone.
        </div>
      </div>
      ...
      <div className="card anim-fade-up-4" style={{ marginBottom: 24 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          {[
            ...
            { icon: "🎣", title: "Phishing awareness", desc: "NourishAI will never ask for your password via email or chat. Be suspicious of any message asking for personal info or payment outside the app." },
            { icon: "🔗", title: "Safe links only", desc: "Only click links sent through official NourishAI emails (from @nourishai.com). Report suspicious links immediately." },
            { icon: "📱", title: "Secure devices", desc: "Always log out of NourishAI on shared devices. Keep your phone and browser updated for the latest security patches." },
            { icon: "💾", title: "Your data rights", desc: "You can request deletion of your account and data at any time by contacting support@nourishai.com. We comply within 30 days." },
          ].map((item, i) => (
      ...
      <div className="card" style={{ textAlign: "center", padding: 32 }}>
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
          <a href="mailto:support@nourishai.com" className="btn btn-primary btn-sm">✉️ support@nourishai.com</a>
          <a href="mailto:report@nourishai.com" className="btn btn-danger btn-sm">🚨 Report a Violation</a>
        </div>
      </div>
    </div>
  );
