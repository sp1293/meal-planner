...
export default function MealPlanner({ navigate }) {
  ...
  function shareOnWhatsApp(plan) {
    ...
    const meals = Object.entries(day1.meals)
      ...
      .join("\n");
    const shopping = Object.entries(plan.shopping_list || {})
    ...
    const message =
      ...
      `_Get your personalized meal plan at Mitabhukta_ 🍛`;
...
Allergies: ${prefs.allergies || "None"}
${prefs.healthConditions ? `Health conditions: ${prefs.healthConditions} — adjust meal plan accordingly.` : ""}
Nutrition focus: ${ag.nutritionFocus}
      ...
      {!mealPlan ? (
        <div className="card anim-fade-up-2" style={{ maxWidth: 780, margin: "0 auto" }}>
          ...
          <button className="btn btn-primary btn-full btn-lg" onClick={generate} disabled={loading || !canGen}>
            {loading ? <><span className="spin">⟳</span>&nbsp; Generating your plan (20-30 sec)...</> : `✨ Generate ${plan.planDays}-Day Meal Plan`}
          </button>
        </div>
      ) : (
