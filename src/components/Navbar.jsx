...
export default function Navbar({ page, navigate }) {
  ...
  const s = {
    ...
    dropdown: { position: "absolute", top: 56, right: 0, background: "#fff", border: "1px solid var(--border)", borderRadius: "var(--radius-md)", padding: "8px", boxShadow: "var(--shadow-lg)", minWidth: 230, animation: "slideDown 0.2s ease forwards" },
    ...
    <nav style={s.nav}>
      <div style={s.inner}>
        ...
        <div style={s.links} className="hide-mobile">
          ...
          {user && (
            <button style={{ ...s.link, ...(page === "leftover-chef" ? s.linkActive : {}) }} onClick={() => navigate("leftover-chef")}>
              🍳 Leftover Chef
            </button>
          )}
          {user && (
